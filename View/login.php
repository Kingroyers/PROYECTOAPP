...
<body class="position-relative d-flex justify-content-center align-items-center">
    ...
    <div class=" d-flex flex-column justify-content-center align-items-center" style="background-color: #101116; width: 100vh; height: 100vh;">
        ...
        $login->loginValidar();
        ?>
        <form method="post" action="" class="w-lg-100 p-4 text-white h-auto mt-sm-5" style="border: 1px solid #fff; border-radius: 10px 10px 10px 50px; min-width: 300px; background-color: #101116;" id="formulario_login">
            <div class="mb-3 text-white  my-4">
                ...
                <p class="formulario__input-error">Introduce un correo electrónico válido. Ej: usuario@example.com</p>
            </div>
            <div class="mb-3 text-white  my-5">
                ...
                <p class="formulario__input-error">La contraseña debe tener al menos 8 caracteres, incluyendo una mayúscula, una minúscula, un número y un carácter especial.</p>
            </div>
